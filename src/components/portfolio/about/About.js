...
function About() {
	return (
		<div className="about">
			...
			Because of this, I joined a 9 month coding academy called Lambda where I learned how to build powerful applications using agile methodologies in a team setting.
